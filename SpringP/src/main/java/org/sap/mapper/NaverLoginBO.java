...
public class NaverLoginBO {
    ...
    private final static String CLIENT_ID = "MJW2ec8CghrdmtYtEvTS"; // 클라이언트 아이디
    private final static String CLIENT_SECRET = "ZUq6ouqZjk"; // 클라이언트 시크릿
    private final static String REDIRECT_URI = "http://localhost:8080/callbackNaver";
    ...
    public String getAuthorizationUrl(HttpSession session) {
        ...
        session.setAttribute("naverSession", state);
    ...
    public OAuth2AccessToken getAccessToken(HttpSession session, String code, String state) throws IOException{
    	...
    	String sessionState = (String) session.getAttribute("naverSession");
