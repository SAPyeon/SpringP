...
<body>
	<div class="container">
		...
		<div class="row main mb-3 align-self-center" role="main" id="main">
			<div
				class="input-form col-md-6 offset-md-3 border mx-auto">
				<h1>회원가입</h1>
				<form action="/member/signup" method="post" id="needs-validation"
					novalidate class="row g-3">
					<div class="form-group">
						<label for="id" class="form-label">ID</label> 
						<input type="text" id="id" placeholder="id...." name="id" required pattern="^[a-z]+[a-z0-9]{5,19}$"
					...
					<div class="form-group">
						<label for="name" class="form-label">NAME</label> <input
							type="text" id="name" placeholder="name...." name="name" required class="form-control form-control-lg">
