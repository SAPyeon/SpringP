	...
	<div class="container">
		...
		<div class="row main d-flex flex-column justify-content-center">
			...
			<div class="border mb-3 col col-sm-8 align-self-center" id="title">
				<label>작성자 : </label><label>${detail.name}(${detail.id})</label>
			</div>
			<div class="border mb-3 col col-sm-8 align-self-center p-3"
				id="content">${detail.content}</div>
			...
			<div class="row d-flex justify-content-center m-3">
				<textarea name="reply" class="col col-sm-7 align-self-center mr-2"
					id="reply"></textarea>
				<button type="submit" class="btn btn-primary col col-sm-1 mx-2"
					id="btn_reply">작성</button>
			</div>
